    ...
    public class GhostListOnTile {
        ...
        void LocateGhostsOnTile(ITile enviTile) {
            ...
            for (int i = 0; i < figureLocator.howMuchEnemiesOnTile; i++) {
                ...
                newGhost.Position = GhostListOnTile.RandomLocate(newGhost.Tile);
        ...
        static Vector3 RandomLocate(ITile enviTile) {
            Vector2 center = new Vector2(enviTile.IndexPosition.x * enviTile.Size, enviTile.IndexPosition.y * enviTile.Size);
            ...
            Vector2 randomPosition = GhostListOnTile.VectorRandomFunction(LeftDownCorner, RightUpCorner);
