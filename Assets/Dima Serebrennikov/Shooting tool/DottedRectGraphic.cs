// DottedRectGraphic.csC:\Feeble snow\Assets\Serebrennikov\Shooting tool\DottedRectGraphic.csDottedRectGraphic.cs
using System;
...
namespace Serebrennikov {
    ...
    public class DottedRectGraphic : MaskableGraphic {
        public enum Mode { FillInside = 0, FillOutside = 1, Edge = 2 }

        [SerializeField] int detail = 64;
