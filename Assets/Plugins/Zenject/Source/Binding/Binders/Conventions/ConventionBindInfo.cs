...
namespace Zenject {
    ...
    public class ConventionBindInfo {
        readonly List<Func<Type, bool>> _typeFilters = new();
        readonly List<Func<Assembly, bool>> _assemblyFilters = new();

#if ZEN_MULTITHREADING
        readonly object _locker = new object();
#endif
        static Dictionary<Assembly, Type[]> _assemblyTypeCache = new();
